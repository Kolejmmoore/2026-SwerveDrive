...
public class intake extends SubsystemBase {
  ...
  .withClosedLoopController(0, 0, 0, DegreesPerSecond.of(30), DegreesPerSecondPerSecond.of(45))
  .withSimClosedLoopController(0, 0, 0, DegreesPerSecond.of(30), DegreesPerSecondPerSecond.of(45))
  ...
  private SparkMax spark = new SparkMax(16, MotorType.kBrushless);
